    ...
    public sealed partial class MainPage : Page
    {
        ...
        private async Task<bool> StartWebcamStreaming()
        {
            ...
            try
            {
                ...
                settings.VideoDeviceId = _deviceList[_deviceList.Count - 1].Id;  //if there's a external camera, use it; if none, use the built-in camera. 
        ...
        /// <summary>
        /// CaptureButton to capture a picture
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
